...
extern const unsigned char kAgentsDeepseekCipher[];
extern const size_t kAgentsDeepseekCipherLen;
extern const unsigned char kAgentsDeepseekKey[];
extern const size_t kAgentsDeepseekKeyLen;

extern const unsigned char kAuthContextCipher[];
extern const size_t kAuthContextCipherLen;
extern const unsigned char kAuthContextKey[];
extern const size_t kAuthContextKeyLen;
...
std::string get_resource(ResId id) {
    switch (id) {
        ...
        case ResId::AuthContext:
            return xor_decrypt(kAuthContextCipher, kAuthContextCipherLen, kAuthContextKey, kAuthContextKeyLen);
